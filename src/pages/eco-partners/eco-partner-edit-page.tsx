		...
		return (
			<div className="w-full py-6 px-6">
				<div className="text-center py-12">
					...
					<Button onClick={() => navigate("/eco-partners")} className="bg-gradient-to-r from-brand-green to-green-600 hover:from-green-600 hover:to-green-700 text-white text-p3 font-semibold">
						Geri Dön
					</Button>
				</div>
			</div>
