			...
			{totalPages > 1 && (
				<div className="flex items-center justify-between">
					<div className="text-p3 text-muted-foreground">
						Toplam <span className="font-semibold text-foreground">{totalElements}</span> sayfa
					</div>
...
function PageTableRow({ page, onView, onEdit, onDelete }: PageTableRowProps) {
	return (
		<TableRow className="hover:bg-muted/50 transition-colors">
			...
			<TableCell>
				<span className="text-p3 text-muted-foreground font-mono">{page.slug}</span>
			</TableCell>
			<TableCell>
