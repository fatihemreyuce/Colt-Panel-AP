				...
				<CardHeader className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border-b-2">
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<div>
								<CardTitle className="text-xl font-bold">Takım Üyesi Listesi</CardTitle>
						...
						<Table>
							<TableHeader>
								<TableRow className="bg-gradient-to-r from-muted/50 via-muted/30 to-transparent hover:bg-muted/60 border-b-2 border-border/50">
									...
									<TableHead>
										<span className="text-sm font-bold text-foreground">Fotoğraf</span>
									</TableHead>
...
function TeamMemberTableRow({ member, onView, onEdit, onDelete }: TeamMemberTableRowProps) {
	return (
		<TableRow className="hover:bg-gradient-to-r hover:from-primary/5 hover:to-transparent transition-all duration-200 group border-b border-border/30">
			<TableCell className="font-bold text-green-500 py-4">{member.id}</TableCell>
			...
			<TableCell className="py-4">
				{member.email ? (
					<a
						...
						className="inline-flex items-center gap-1.5 text-sm text-foreground hover:text-primary font-medium hover:underline transition-colors"
					>
